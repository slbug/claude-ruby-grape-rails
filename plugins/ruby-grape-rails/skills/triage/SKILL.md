...
5. `## Phase 1: Blockers [PENDING]` — task lines `- [ ] [P1-Tn][annotation] ...` (every NEW BLOCKER, auto-included).
6. `## Phase 2: Warnings (selected) [PENDING]` — task lines `- [ ] [P2-Tn][annotation] ...` (only NEW WARNINGs the user selected at Step 4).
