...
description: "Use when sharing verify-output compression telemetry with the plugin maintainers as an anonymized GitHub-issue-ready report. Reads ${CLAUDE_PLUGIN_DATA}/compression.jsonl, redacts PII, drafts an actionable report with sample-by-sample reasoning, hands it back for the user to copy into a GitHub issue."
