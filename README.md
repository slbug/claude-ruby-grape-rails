...
| Ruby | 3 | Always pair method_missing with respond_to_missing?; Always supervise background processes; Never `rescue Exception`; bare `rescue` is safe (defaults to StandardError) |
